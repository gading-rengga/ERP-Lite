...
<?php
$get_divisi = $this->M_auth->get_divisi($data_user['divisi']);
$get_dpartement = $this->M_auth->get_dpartement($data_user['id_dpartement']);
?>
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="#" target="_blank" class="text-dark-75 text-hover-primary"><?= $get_dpartement[0]['nama_dpartement'] ?></a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $data_user['employe_name'] ?></a>
                <div class="text-muted mt-1"><?= $get_divisi[0]['name_divisi'] ?></div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            <span class="navi-icon mr-1">
                                <span class="svg-icon svg-icon-lg svg-icon-primary">
                                    <!--begin::Svg Icon | path:<?= base_url('assets/metronic-v7/') ?>media/svg/icons/Communication/Mail-notification.svg-->
                            ...
                            <span class="navi-text text-muted text-hover-primary"><?= $data_user['email'] ?></span>
                        </span>
                    </a>
...
<!-- Bootstrap-Notify -->
<script src="<?= base_url('assets/metronic-v7/') ?>js/pages/features/miscellaneous/bootstrap-notify.js"></script>
</body>
<!--end::Body-->
