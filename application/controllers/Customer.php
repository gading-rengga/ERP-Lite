...
class Customer extends CI_Controller
{
            ...
            foreach ($data_table as $index => $key) {
                if ($key['id_dpartement'] == $id_dpartement) {
                    ...
                    $config_button_edit = array(
                        array(
                            'button' => array(
                                'button_link'      => 'Customer/form/' . $key['id'],
                                'button_title'    => 'Edit',
                                'button_color'     => 'primary'
                            ),
                        )
                    ...
                    $config_button_delete = array(
                        array(
                            'button' => array(
                                'button_link'      => 'Customer/delete_data/' . $key['id'],
                                'button_title'    => 'Hapus',
                                'button_color'     => 'primary'
                            ),
                        )
    ...
    public function card_form($id)
    {
        $data = array(
            array(
                'title'    => 'Form Customer',
                'action'    =>  $id == '' ? 'Customer/add_data' : 'Customer/update_data',
                'button_save' => array(
                    'button_title'    => 'Save',
    ...
    public function add_data()
    {
        ...
        $data = array(
            ...
            'type'      => 1 // type satu adalah type customer
        );
